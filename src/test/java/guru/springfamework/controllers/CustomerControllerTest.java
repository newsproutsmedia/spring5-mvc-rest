...
public class CustomerControllerTest {
    ...
    public static final String FIRSTNAME = "Foxy";
    public static final String LASTNAME = "Cleopatra";
    public static final String URL = "/shop/customer/";
